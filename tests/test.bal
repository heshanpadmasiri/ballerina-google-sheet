...
function testCreateSpreadsheet() {
    ...
    if (spreadsheetRes is Spreadsheet) {
        ...
        spreadsheetId = <string>spreadsheetRes.spreadsheetId;
    } else {
...
function testRemoveSheet() {
    ...
    if (openRes is Sheet) {
        ...
        int sheetId = <int>openRes.properties?.sheetId;
...
function testSetRowMetadata() returns error? {
    ...
    error? response = spreadsheetClient->setRowMetaData(spreadsheetId, <int>sheet.properties?.sheetId, 1, "DOCUMENT", "metadataKey", "value1");
...
function testUpdateRowFromSheetWithFilter() returns error? {
    ...
    Sheet sheet = check spreadsheetClient->getSheetByName(spreadsheetId, testSheetName);
    error? response = spreadsheetClient->updateRowByDataFilter(spreadsheetId, <int>sheet.properties?.sheetId, <A1Range>{sheetName: testSheetName, startIndex: "A3", endIndex: "C3"}, values, valueInputOption = "USER_ENTERED");
    if response !is error {
    ...
    GridRangeFilter gridRangeFilter = {sheetId: <int>sheet.properties?.sheetId, startRowIndex: 1, endRowIndex: 2, startColumnIndex: 0, endColumnIndex: 4};
    ...
    response = spreadsheetClient->updateRowByDataFilter(spreadsheetId, <int>sheet.properties?.sheetId, gridRangeFilter, values_gridRange, valueInputOption = "USER_ENTERED");
    if response !is error {
    ...
    response = spreadsheetClient->updateRowByDataFilter(spreadsheetId, <int>sheet.properties?.sheetId, developerMetadataLookupFilter, values_metadata, valueInputOption = "USER_ENTERED");
    if response !is error {
...
function testGetRowFromSheetWithFilter() returns error? {
    Sheet sheet = check spreadsheetClient->getSheetByName(spreadsheetId, testSheetName);
    ValueRange[]|error spreadsheetRes = spreadsheetClient->getRowByDataFilter(spreadsheetId, <int>sheet.properties?.sheetId, <A1Range>{sheetName: testSheetName, startIndex: "A3", endIndex: "C3"});
    ...
    GridRangeFilter gridRangeFilter = {sheetId: <int>sheet.properties?.sheetId, startRowIndex: 1, endRowIndex: 2, startColumnIndex: 0, endColumnIndex: 4};
    DeveloperMetadataLookupFilter developerMetadataLookupFilter = {locationType: "ROW", metadataKey: "metadataKey", metadataValue: "value1"};
    spreadsheetRes = spreadsheetClient->getRowByDataFilter(spreadsheetId, <int>sheet.properties?.sheetId, gridRangeFilter);
    if spreadsheetRes is ValueRange[] {
        test:assertEquals({"rowPosition": spreadsheetRes[0]["rowPosition"], "values": spreadsheetRes[0]["values"], "startIndex": spreadsheetRes[0]["a1Range"].startIndex, "endIndex": spreadsheetRes[0]["a1Range"].endIndex},
    ...
    spreadsheetRes = spreadsheetClient->getRowByDataFilter(spreadsheetId, <int>sheet.properties?.sheetId, developerMetadataLookupFilter);
    if spreadsheetRes is ValueRange[] {
        test:assertEquals({"rowPosition": spreadsheetRes[0]["rowPosition"], "values": spreadsheetRes[0]["values"], "startIndex": spreadsheetRes[0]["a1Range"].startIndex, "endIndex": spreadsheetRes[0]["a1Range"].endIndex},
...
function testGetRowFromSheetWithAFaultyMetadataFilter() returns error? {
    ...
    ValueRange[]|error rowResp = spreadsheetClient->getRowByDataFilter(spreadsheetId, <int>sheet.properties?.sheetId, developerMetadataLookupFilter);
    if rowResp !is error {
...
function testDeleteRowFromSheetWithFilter() returns error? {
    Sheet sheet = check spreadsheetClient->getSheetByName(spreadsheetId, testSheetName);
    error? response = spreadsheetClient->deleteRowByDataFilter(spreadsheetId, <int>sheet.properties?.sheetId, <A1Range>{sheetName: testSheetName, startIndex: "A3", endIndex: "C3"});
    if response is () {
    ...
    GridRangeFilter gridRangeFilter = {sheetId: <int>sheet.properties?.sheetId, startRowIndex: 1, endRowIndex: 2, startColumnIndex: 0, endColumnIndex: 4};
    DeveloperMetadataLookupFilter developerMetadataLookupFilter = {locationType: "ROW", metadataKey: "metadataKey", metadataValue: "value1"};
    response = spreadsheetClient->deleteRowByDataFilter(spreadsheetId, <int>sheet.properties?.sheetId, gridRangeFilter);
    if response is () {
    ...
    response = spreadsheetClient->deleteRowByDataFilter(spreadsheetId, <int>sheet.properties?.sheetId, developerMetadataLookupFilter);
    if response is () {
...
function testAppendValueWithBooleanAndFloat() {
    ...
    if spreadsheetRes is ValueRange {
        test:assertEquals({"rowPosition": spreadsheetRes["rowPosition"], "values": spreadsheetRes["values"], "startIndex": spreadsheetRes["a1Range"].startIndex, "endIndex": spreadsheetRes["a1Range"].endIndex},
        {"rowPosition": 1, "values": ["Appending", "Some", "Values", false, 10], "startIndex": "F1", "endIndex": "J1"}, msg = "Appending a row to range failed");
    } else {
        test:assertFail(spreadsheetRes.message());
    }
}
...
function testAppendValueWithAllDataTypes() {
    ...
    if spreadsheetRes is ValueRange {
        test:assertEquals({"rowPosition": spreadsheetRes["rowPosition"], "values": spreadsheetRes["values"], "startIndex": spreadsheetRes["a1Range"].startIndex, "endIndex": spreadsheetRes["a1Range"].endIndex},
        {"rowPosition": 2, "values": ["Appending", "Some", "Values", false, 10.1d, dec], "startIndex": "F2", "endIndex": "K2"}, msg = "Appending a row to range failed");
    } else {
        test:assertFail(spreadsheetRes.message());
    }
}
